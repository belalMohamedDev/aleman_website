...
const CARDS = [
  { id: 'experience', icon: FactoryIcon, title: ui.trust.experienceTitle, body: ui.trust.experienceBody, stat: '+33 عاماً', span: 'lg:col-span-2', tone: 'dark' as const },
        ...
        {CARDS.map((card, index) => {
          ...
          return (
            <Reveal
              key={card.id}
              delay={index * 0.06}
              className={`${card.span} relative overflow-hidden rounded-card border p-7 transition-all duration-300 hover:-translate-y-1 hover:shadow-lift ${isDark
            ...
            >
              <div className="flex items-center justify-between">
                <span
                  className={`inline-flex h-13 w-13 items-center justify-center rounded-2xl ${isDark
                ...
                <span
                  className={`text-xs font-black px-3 py-1 rounded-pill ${isDark
