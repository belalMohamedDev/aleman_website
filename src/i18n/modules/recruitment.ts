...
export const recruitment = {
  ...
  trackQueryLabel: L('الرقم القومي', 'National ID'),
  trackQueryHeading: L('الرقم القومي', 'National ID'),
  trackQueryPlaceholder: L('أدخل الرقم القومي', 'Enter National ID'),
  trackAppNoOrNidPlaceholder: L('أدخل الرقم القومي', 'Enter National ID'),
  trackHint: L(
  ...
  errPhotoRequired: L('يرجى إرفاق الصورة الشخصية', 'Personal photo is required'),
  ...
  errQualificationTypeRequired: L('يرجى كتابة التخصص الدراسي / الكلية للمؤهلات العليا', 'Major / Field of study is required for higher education degrees'),
  errUniversityRequired: L('يرجى إدخال اسم الجامعة أو المعهد للمؤهلات العليا', 'University or Institute name is required for higher education degrees'),

  // New fields
  nameQuadHint: L('لازم يكون الاسم رباعياً وبالكامل ومطابقاً لبطاقة الرقم القومي.', 'Full name must be 4 parts matching the national ID card.'),
  nameQuadPlaceholder: L('الاسم الأول ثم الأب ثم الجد ثم العائلة', 'First, Father, Grandfather, Family'),
  birthDateLabel: L('تاريخ الميلاد', 'Date of Birth'),
  birthDatePlaceholder: L('يُستخرج تلقائيًا', 'Calculated automatically'),
  graduationYearLabel: L('سنة التخرج', 'Graduation Year'),
  graduationYearPlaceholder: L('مثال: 2022', 'e.g. 2022'),
  gradeLabel: L('التقدير', 'Grade / GPA'),
  gradeSelectPlaceholder: L('-- اختر التقدير --', '-- Select Grade --'),
  appliedPositionLabel: L('الوظيفة المتقدّم لها', 'Applied Position'),
  jobAndExperienceSection: L('بيانات الوظيفة والخبرة', 'Job & Experience Details'),
  previousExperiencesLabel: L('الخبرات العملية السابقة', 'Previous Work Experience'),
  addExperienceBtn: L('+ إضافة خبرة', '+ Add Experience'),
  companyNamePlaceholder: L('اسم الشركة أو جهة العمل', 'Company / Organization'),
  jobRolePlaceholder: L('المسمى الوظيفي', 'Job Title'),
  fromYearPlaceholder: L('من (سنة/شهر)', 'From'),
  toYearPlaceholder: L('إلى (سنة/شهر)', 'To'),
  trainingCoursesLabel: L('الدورات التدريبية', 'Training Courses'),
  addCourseBtn: L('+ إضافة دورة', '+ Add Course'),
  courseNamePlaceholder: L('اسم الدورة التدريبية', 'Course Title'),
  courseDatePlaceholder: L('التاريخ / السنة', 'Date / Year'),
  courseDurationPlaceholder: L('المدة (مثال: شهر)', 'Duration (e.g. 1 Month)'),
  additionalInfoSection: L('بيانات إضافية', 'Additional Details'),
  isDriverLabel: L('يحمل رخصة قيادة', 'Holds a Driver’s License'),
  licenseTypePlaceholder: L('درجة / نوع الرخصة (مثال: خاصة، مهنية ثالثة...)', 'License category (e.g. Private, Commercial 3rd)'),
  isSmokerLabel: L('مدخّن', 'Smoker'),
  hasSurgeriesLabel: L('أجرى عمليات جراحية', 'Underwent Surgeries'),
  surgeryTypesPlaceholder: L('تفاصيل العمليات الجراحية إن وجدت', 'Surgery details if applicable'),
  hasRelativesLabel: L('هل لديك أقارب في الشركة؟', 'Relatives working in the company?'),
  relativesInfoPlaceholder: L('اسم القريب وصلة القرابة وقسم العمل', 'Relative name, relationship, and department'),
  photoRequiredLabel: L('الصورة الشخصية', 'Personal Photo'),
  photoRequiredHint: L('صورة حديثة وواضحة (JPG أو PNG)', 'Clear recent photo (JPG or PNG)'),
  certificatesLabel: L('الشهادات (متعددة)', 'Certificates (Multiple)'),
  certificatesHint: L('شهادات إضافية أو دورات (PDF أو صور)', 'Additional certificates or courses (PDF/Images)'),
  uploadCertificatesBtn: L('إرفاق شهادات إضافية', 'Upload Certificates'),
  filesSelected: L('ملفات تم اختيارها', 'files selected'),
  removeCourse: L('حذف الدورة', 'Remove course'),
  removeExperience: L('حذف الخبرة', 'Remove experience'),
};
