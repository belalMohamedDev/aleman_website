...
export const articles: Article[] = [
  ...
  },
  {
    ...
    excerpt: L(
      'منظومة الجودة في مجموعة شركات الايمان تبدأ من اختيار المواد الخام وتستمر حتى نهاية عملية التعبئة.',
      'The quality system at Aleman Foundation starts with raw material selection and continues to the end of packaging.'
    ),
    body: [
      L(
        'تُصر مجموعة شركات الايمان على الجودة الشاملة في جميع مراحل عمليات التصنيع بدءًا من اختيار المواد الخام خلال عملية التصنيع بأكملها وحتى نهاية عملية التعبئة عالية الجودة.',
