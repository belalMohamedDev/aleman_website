...
{
  id: 'foundation',
  title: L('تأسيس المؤسسة', 'Company founding'),
  description: L(
    'انطلاق مؤسسة الإيمان للأعلاف كمؤسسة مصرية متخصصة في تصنيع الأعلاف.',
...
},
{
  ...
  description: L(
    'اتساع نشاط المؤسسة ليغطي قطاعات الدواجن والمواشي والأرانب والبط.',
